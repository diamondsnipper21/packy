...
return [
    ...
    'auth' => [
        ...
        'extra_info' => 'You can retrieve your api key by visiting your setting and clicking <b>Generate API Key</b>.',
    ],
        ...
        'headers' => [
            ...
            [
                ...
                [
                    ...
                    'X-API-KEY' => 'pk_nebsaibTVdyUILEzwQ5sQ5tV2d797bsu',
                ]
            ]
        ],
        'bodyParameters' => [
