...
@section('content')
    ...
    <br /><br />
    Nous vous rappelons que votre abonnement pour la communauté <b>{{ $communityName }}</b> d'un montant de {{ number_format($plan['amount'], 2, ',', '') }} {{ $plan['currency'] }} va automatiquement être renouvelé le {{ $nextBillingDate }}.
    <br /><br />
